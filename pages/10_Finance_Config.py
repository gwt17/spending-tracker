...
">
    ...
    <div style="font-family:'DM Sans',sans-serif;font-size:13px;color:rgba(255,255,255,0.65);margin-top:6px;">
        Track contributions that don't appear in your bank exports — 401k, HSA, ESPP, Roth IRA, etc.
        Used by the Money Summary page to calculate your true savings rate.
    </div>
</div>
""", unsafe_allow_html=True)
